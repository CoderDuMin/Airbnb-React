...
export const fetchEntireRoomsAction = createAsyncThunk('fetch/entire',async (page,{dispatch}) => {
...
export const { changeRoomListAction,changeCurrentPageAction,changeTotalCountAction,changeIsLoadingAction } = entireReducer.actions
